              ...
              children: [
                ListTile(
                  ...
                  subtitle: Column(
                    ...
                    children: <Widget>[
                      Text(
                        widget.bankData[0]["UPIID"] == null
                            ? "UPI Id : 9995552221@upi"
                            : "UPI Id : ${widget.bankData[0]["UPIID"]}",
                        style: TextStyle(fontSize: 15),
                      ),
                      Text(
                        "Account Number : ${widget.bankData[0]["AccountNo"]}",
                        style: TextStyle(fontSize: 15),
                      ),
                      Text(
                        "IFSC Number : ${widget.bankData[0]["IFSCCode"]}",
                        style: TextStyle(fontSize: 15),
                      ),
                      Text(
                        widget.bankData[0]["UPIID"] == null
                            ? "Address : Surat, Gujarat"
                            : "Adress : ${widget.bankData[0]["BankAddress"]}",
                        style: TextStyle(fontSize: 15),
                      ),
                    ],
                  ),
