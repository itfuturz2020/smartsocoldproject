  ...
  _checkWishList() async {
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        String advertisementid = widget.data["Id"].toString();
  ...
  _wishListDelete() async {
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        var data = {
          "AdvertisementId": widget.data["Id"].toString(),
    ...
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        var data = {
          ...
          "AdvertisementId": widget.data["Id"],
        };
              ...
              Stack(
                children: <Widget>[
                  FadeInImage.assetNetwork(
                      ...
                      image: "${cnst.Image_Url}" + widget.data["Image"]),
                  Padding(
                    padding:
