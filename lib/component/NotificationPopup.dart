...
class _NotificationPopupState extends State<NotificationPopup> {
  ...
  String SocietyId;
  final List<String> _notifcationReplylist = ["APPROVED", "LEAVE AT GATE", "DENY"];
  int selected_Index;
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: (){
                            NotificationReply(_notifcationReplylist[1],widget.data["data"]["EntryId"],widget.data["data"]["WatchmanId"]);
                            Get.back();
                          },
                          child: Column(
                            children: <Widget>[
