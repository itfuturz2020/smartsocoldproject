          ...
          Services.UpdateProfilephoto(formData).then((data) async {
            ...
            if (data.Data != "0" && data.IsSuccess == true) {
              await prefs.setString(
                  constant.Session.Profile, data.Data);
        ...
        try {
          ...
          if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
            ...
            var data1 = {
              ...
              "WingId": wingId,
              "Name": Nametxt.text,
              "ContactNo": MobileNumbertxt.text,
              "FlatNo": FlatNo,
            ...
            pr.show();
            SharedPreferences prefs = await SharedPreferences.getInstance();
            Services.UpdateMemberProfile(data1).then((data) async {
              pr.hide();
              if (data.Data != "0" && data.IsSuccess == true) {
                await prefs.setString(
          ...
          child: Column(
            children: <Widget>[
                            ...
                            decoration: BoxDecoration(
                                image: new DecorationImage(
                                    ...
                                    AssetImage("images/man.png")
                                        :NetworkImage(constant.Image_Url+'$Profile')
                                        : FileImage(_image),
                                    fit: BoxFit.cover),
                                borderRadius:
              ...
              Padding(
                ...
                child: Text("Private Your Profile",style: TextStyle(
                    fontSize: 14,
