        ...
        if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
          ...
          Services.MemberLogin(_MobileNumber.text).then((data) async {
            ...
            if (data != null && data.length > 0) {
              await prefs.setString(constant.Session.session_login,
                  data[0]["ContactNo"].toString());
              await prefs.setString(
                  constant.Session.Member_Id, data[0]["Id"].toString());
              await prefs.setString(
                  constant.Session.SocietyId, data[0]["SocietyId"].toString());
              await prefs.setString(constant.Session.IsVerified,
              ...
              await prefs.setString(constant.Session.ResidenceType,
                  data[0]["ResidenceType"].toString());
              await prefs.setString(
                  constant.Session.FlatNo, data[0]["FlatNo"].toString());
              await prefs.setString(
                  constant.Session.Name, data[0]["Name"].toString());
              await prefs.setString(constant.Session.CompanyName,
                  data[0]["CompanyName"].toString());
              await prefs.setString(constant.Session.Designation,
                  data[0]["Designation"].toString());
              await prefs.setString(constant.Session.BusinessDescription,
                  data[0]["BusinessDescription"].toString());
              await prefs.setString(constant.Session.BloodGroup,
                  data[0]["BloodGroup"].toString());
              await prefs.setString(
                  constant.Session.Gender, data[0]["Gender"].toString());
              await prefs.setString(
                  constant.Session.DOB, data[0]["DOB"].toString());
              await prefs.setString(
                  constant.Session.Address, data[0]["Address"].toString());
              await prefs.setString(
                  constant.Session.isPrivate, data[0]["IsPrivate"].toString());
              await prefs.setString(
                  constant.Session.Wing, data[0]["Wing"].toString());
              await prefs.setString(
                  constant.Session.WingId, data[0]["WingId"].toString());
              await prefs.setString(
                  constant.Session.ParentId, data[0]["ParentId"].toString());
              await prefs.setString(
                  constant.Session.Profile, data[0]["Image"].toString());
