...
class _MyProfileScreenState extends State<MyProfileScreen> {
  ...
  _getLocaldata() async {
    ...
    setState(() {
      ...
      ResidanceType = prefs.getString(constant.Session.ResidenceType);
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: NoticeData[index]["Type"] == "Car"
                        ? Image.asset(
            ...
            child: Column(
              children: <Widget>[
                ...
                ListTile(
                  ...
                  title: MobileNumber != 'null' && MobileNumber != '' ? Text('$MobileNumber'): Text(''),
                ...
                ListTile(
                  ...
                  title: BusinessJob != 'null' && BusinessJob != '' ? Text('$BusinessJob'): Text('')
                ),
                Padding(
                  padding: const EdgeInsets.only(left: 30.0),
                  child: Container(
                ...
                ListTile(
                  ...
                  title: Description != 'null' && Description != '' ? Text('$Description'): Text('')
                ),
                Padding(
                  padding: const EdgeInsets.only(left: 30.0),
                  child: Container(
                ...
                ListTile(
                  ...
                  title: CompanyName != 'null' && CompanyName != '' ? Text('$CompanyName'): Text(''),
                ...
                ListTile(
                  leading: Image.asset('images/Blood.png',
                      width: 22, height: 22, color: Colors.grey[500]),
                  title: BloodGroup != 'null' && BloodGroup != '' ? Text('$BloodGroup'): Text(''),
                ...
                ListTile(
                  leading: Image.asset('images/gender.png',
                      width: 22, height: 22, color: Colors.grey[500]),
                  title: Gender != 'null' && Gender != '' ? Text('$Gender'): Text(''),
    ...
    return Dialog(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            padding: const EdgeInsets.only(top: 18.0, left: 8, right: 8,bottom: 8.0),
            child: SizedBox(
